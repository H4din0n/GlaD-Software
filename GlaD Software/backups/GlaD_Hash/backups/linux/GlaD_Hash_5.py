...
def text_qr():
	...
	print(green_bold+'enter text> '+red_bold)
...
def steg_enc():
	...
	while True:
		...
		data = steg_enc.encode()

		im1 = stepic.encode(im, data)

		steg_enc_res = input(green_bold+'save file> ')
...
def steganography():
	...
	while True:
		...
		steg_input = input(yellow_bold+'steganography> '+no_colored)
		...
		if steg_input == ('senc'):
			...
			print(ǵreen_bold+"senc    ----------------------->  encryption mode")
			print(ǵreen_bold+'sdec    ----------------------->  decryption mode')
