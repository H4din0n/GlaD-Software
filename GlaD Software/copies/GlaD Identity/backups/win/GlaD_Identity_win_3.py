...
def fingerprint(): 
  ...
  global no_colored, white_bold, blue_bold, green_bold, red_bold, yellow_bold, global_ciphertext, gl_hash
...
######################################################
    ...
    python_hash = str(hash(blake2s_hex_dig))

    gl_hash = gl_hash + python_hash
