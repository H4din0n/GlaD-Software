...
def multi_h(): 
	...
	while True:
		...
		md5_string = input(yellow_bold+'multiple_hash> '+no_colored)
		...
		print(green_bold+hex_dig_sha224)
...
def hashing_menu():
	...
	while True:
		...
		if hashing_option == ('md5'):
			...
			print(green_bold+"mh      ----------------------->  multiple hash")
			print("")
...
def secret():
    ...
    qr.make(fit=True)
    img = qr.make_image(fill='black', back_color='white')
    img.save('easter egg.png')
    print('image for easter egg created')
    on_start()
...
def exif_extract():
	...
	while True:
		...
		img_file = input(yellow_bold+'imagename> '+no_colored)
		...
		if img_file == ('cd'):
			...
			print(green_bold+'')
			print(green_bold+'cd ----------------------> brings you back to start')
			print(green_bold+'')

		else:
			print(red_bold+img_file, 'isnt a command')
...
def easter():
	...
	while True:
		...
		if operating_system == ('win32'):
			...
			print('oh shit i smell mackbook and it aint good :( !!!!!!!!!')
...
def GlaD_Chat():
	...
	global no_colored, white_bold, blue_bold, green_bold, red_bold, yellow_bold, port, host

	while True:

		print('')

		glc_menu = input(yellow_bold+'GlaD_Chat menu> '+no_colored)
		...
		if glc_menu == ('host'):
			...
			print(green_bold)
			print('host         -----------------> makes your device to local chat host')
			print('port         -----------------> change port')
			print('chip         ----------------> change host ip')
			print('set defaults -----------------> enter thist to set deafaults, if you dont the chat dosnt work')
			print('cd           -----------------> go back')
			#print('connect ---------------------> you can connect to local hosted chat')
			print('')
			...
			port_inp = int(input('set port> '+no_colored))

			port = port + port_inp

			print('')
			print(green_bold + str(port))

		elif glc_menu == ('chip'):

			print('')

			host_inp = input(yellow_bold+'set host ip> '+no_colored)

			host = host + host_inp

			print('')
			print(green_bold + host)

		elif glc_menu == ('set defaults'):
			...
			print(red_bold + glc_menu + ' isnt a command')
...
def GlaD_Bot():
	...
	while True:
		...
		glb_menu = input(yellow_bold+'GlaD_Bot menu> '+no_colored)
		...
		if glb_menu == ('host'):
			...
			print(green_bold)
			print('host         -----------------> makes your device to local bot controller host')
			#print('crf          -----------------> create bot file')
			print('')

		else:
			print(red_bld + glb_menu, "isnt a command try again")
...
def on_start():
	...
	while True:
		...
		if command ==("exit"):
		...
		elif command == ('jo mama'):
			secret()
			break

		elif command == ('d4defc9e3a90745a1ee4c1fde032501f982829dc2fdcaac326cf454cab8bad17'):
			easter()
			break
			...
			print('exif    ----------------------->  exif image extractor')
			print('gle     ----------------------->  starts implemented GlaD_Editor')
			print('gls     ----------------------->  starts implemented GlaD_Scanner')
			print('glt     ----------------------->  starts implemented GlaD_Tube')
			print('glc     ----------------------->  starts implemented GlaD_Chat to host a chat')
			print('glb     ----------------------->  starts implemented GlaD_bot to host botnet ')
			print('')
...
def GD586b44f67445532219fee6479274e926fb82b30c9915f79bc179d1b1e263fb6bID():
