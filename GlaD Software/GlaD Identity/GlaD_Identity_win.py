...
def enigma():
  ...
  global plugboard, no_colored, white_bold, blue_bold, green_bold, red_bold, yellow_bold, global_ciphertext

  print("")

  plaintext = input(yellow_bold+"fingerprint_text> "+no_colored)

  print(''+green_bold)
  print('[*] enter letter combinations for your plugboard settings example:')
  print('AB CD EF GH IJ KL MN OP QR ST UV WX YZ')
  print('')
  ...
  ciphertext = ciphertext + global_ciphertext
